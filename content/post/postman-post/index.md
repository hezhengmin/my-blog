...
```
![postman_test](./postman_test.jpg)

```
程式回傳jwt token
```
![postman_jwt](./postman_jwt.jpg)

## 2. 新增JWT變數
![postman_add_env](./postman_add_env.jpg)

![postman_save_env](./postman_save_env.jpg)

## 3. Request API上加入Token (Authorization)
![postman_setting_env](./postman_setting_env.jpg)

## 4. Request API上加入Token (Header)
![postman_setting_header](./postman_setting_header.jpg)
